function(metatron_evaluate unit path mode)
  ...
  if(NOT ${unit} STREQUAL "prelude")
    set(prelude-include ${metatron-root}/src/prelude/include)
    set(prelude-header ${prelude-include}/metatron/prelude/prelude.hpp)
    if(NOT ${mode} STREQUAL "lib")
      target_link_libraries(${target} PUBLIC metatron-prelude)
      target_precompile_headers(${target} PUBLIC ${prelude-header})
    else()
      target_link_libraries(${target} INTERFACE metatron-prelude)
      target_precompile_headers(${target} INTERFACE ${prelude-header})
    endif()
  endif()
endfunction()
