...
namespace mtt::light {
    ...
    auto constexpr atmo_num_albedo = 2;
    auto constexpr atmo_lambda = std::array<f32, atmo_num_lambda>{
        320.f, 360.f, 400.f, 440.f, 480.f, 520.f, 560.f, 600.f, 640.f, 680.f, 720.f
    };
    auto constexpr atmo_step = 40.f;
    ...
    auto constexpr sun_perp_radiance = std::array<f32, atmo_num_lambda>{
        7500.0f, 12500.0f, 21127.5f, 26760.5f, 30663.7f, 27825.0f,
        25503.8f, 25134.2f, 23212.1f, 21526.7f, 19870.8f,
    };
    auto constexpr tgmm_num_turbility = atmo_num_turbility - 1;
    ...
    private:
        ...
        buf<f32> sky_params; // fm<atmo_num_lambda, sky_num_params> sky_params;
        buf<f32> sky_radiance; // fv<atmo_num_lambda> sky_radiance;
        buf<f32> sun_radiance; // fm<sun_num_segments, atmo_num_lambda, sun_num_ctls> sun_radiance;
        buf<f32> sun_limb; // fm<atmo_num_lambda, sun_num_limb_params> sun_limb;
